...
<div id="mobilenav">
	...
	<section id="content">
		...
		<main>
			...
			echo "<input type='hidden' name='patientid' value='$uid'>";
			echo "<h3 id='patientname' style='margin-top:50px;margin-bottom:10px;'>Patient Name: ".$val['name']." </h3>";
			

		?>
		<div  id="setappointmentcontainer" class="setappointmentforpatient flex flex-row flex-nowwrap">
			...
			<div class="container" style="margin-top:0">
					<a href="#" class="cancel" onclick="history.back()">
